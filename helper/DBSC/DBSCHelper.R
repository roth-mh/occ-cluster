...
formatVert <- function(WETA_df, covObj){
  ...
  v_pts <- sqldf("SELECT latitude, longitude, checklist_id, summer_nbr_TCB_mean_2400,
                spring_nbr_TCG_mean_75, fall_nbr_B2_stdDev_300, slope_mean_300,
                summer_b5_B4_stdDev_1200 from v_pts_df group by latitude, longitude")
