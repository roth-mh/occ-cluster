#!/bin/csh
#SBATCH -J baseline                       # name of job

#SBATCH -A eecs                        # name of my sponsored account, e.g. class or research group

#SBATCH -p gpu                                # name of partition or queue

#SBATCH -o baseline.out                    # name of output file for this submission script

#SBATCH -e errBaseline.err                    # name of error file for this submission script
